...
// Upload gambar untuk SuratMasuk
function UploadSuratMasuk($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../foto/foto_suratmasuk/";
  $vfile_upload = $vdir_upload . $fupload_name;
  ...
  //Simpan gambar
  imagejpeg($im3,$vdir_upload . "medium2_" . $fupload_name);
  //--------------------------------
...
// Upload gambar untuk SuratKeluar
function UploadSuratKeluar($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../foto/foto_suratkeluar/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
//---------------------------------------------------------------------------------------------Upload gambar untuk Permhonan
function UploadMohon($fupload_name){
  //direktori gambar
  $vdir_upload = "../foto/lampiran/";
  $vfile_upload = $vdir_upload . $fupload_name;
