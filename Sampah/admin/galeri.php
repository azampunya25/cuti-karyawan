...
if ($tipe_file != "image/jpeg" AND $tipe_file != "image/png"){
 ...
 $input="insert into galeri (nama_foto, foto) values ('$nama','$direktori2')";
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
                           ...
                           <li><a href="#">Galeri</a><span class="divider-last">&nbsp;</span></li>
						</ul>
				...
				<div id="page" class="dashboard">
                    ...
                    <div class="alert alert-info">
                        <button data-dismiss="alert" class="close">+</button>
                         Selamat datang <strong>Admin</strong>. Silahkan Mengelola Galeri.
                    </div>
					 <!--END NOTIFICATION-->
                     ...
                     <div class="widget-title">
                        <h4><i class="icon-bullhorn"></i> Tambah Galeri</h4>
                        ...
                        <form enctype="multipart/form-data"  id="biodata-form" method="post" class="form-horizontal" onsubmit='return validasi2()'>
						  ...
						  <div class="control-group">
							...
							<div class="control-group">
                                    ...
                                    <div class="controls">
                                     <input type="file" name='gambar' class="default" accept='image/*' /> 
											</div>
							</div>
...
<!---------------------------------------------------SHOW LIST BERITA ----------------------->
               ...
               <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                        <h4><i class="icon-edit"></i> List Galeri</h4>				
                        <span class="tools">
					...
					<?php 
					$i=1;
					$sql= mysql_query("select * from galeri order by id DESC");
					while ($isi= mysql_fetch_array($sql)){
						...
						?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $i;  $i++; ?></td>
									<td class="hidden-phone"><?php echo $isi['nama_foto']; ?></td>
									<td class="center hidden-phone"><?php allfoto($isi['foto']); ?></td>
