...
if(($j % $max == 0) && ($j != 0)){
  ...
  $v_text .= " " . $split_text[$i] . " ";
    ...
    $sql = mysql_query("INSERT INTO komentar(nama_komentar,url,isi_komentar,id_berita,tgl,jam) 
                        VALUES('$nama_komentar','$url','$v_text','$_POST[id]','$tgl_sekarang','$jam_sekarang')");

    echo "<meta http-equiv='refresh' content='0; url=home.php?module=detailberita&id=$_POST[id]'>";
		}else{
