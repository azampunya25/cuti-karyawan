...
class FPDF_AutoWrapTable extends FPDF {
	...
	public function rptDetailData () {
		...
		$this->SetX($left); $this->Cell(0, 10, 'LAPORAN SURAT KELUAR SUBBAG UMUM DAN KEPEGAWAIAN', 0, 1,'C');
		$this->Ln(20);
		...
		$this->SetX($left += 40); $this->Cell(120, $h, 'No Surat', 1, 0, 'C',true);
		$this->SetX($left += 120); $this->Cell(100, $h, 'Tgl Surat', 1, 0, 'C',true);
		$this->SetX($left += 100); $this->Cell(200, $h, 'Pengirim', 1, 0, 'C',true);
		$this->SetX($left += 200); $this->Cell(200, $h, 'Tujuan', 1, 0, 'C',true);
		$this->SetX($left += 200); $this->Cell(200, $h, 'Perihal', 1, 1, 'C',true);
		
		$this->SetFont('Times','',12);
		$this->SetWidths(array(40,120,100,200,200,200));
...
$query = "SELECT * FROM suratkeluar inner join bagian on suratkeluar.id_bagian=bagian.id_bagian	WHERE (((tgl_surat) BETWEEN '".$_POST['dari']."' AND '".$_POST['sampai']."'))";  
