...
switch($_GET[act]){
  ...
  default:
    ...
    $tampil=mysql_query("SELECT * FROM pegawai inner join jabatan on pegawai.id_jabatan=jabatan.id_jabatan  ORDER BY nip ASC");
    $no=$posisi+1;
    while ($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td class='center' width='25'>$no</td>
				...
				echo "</td>
                <td class='center' width='85'><a href=?module=pegawaiviewkadis&act=pegawaidetail&id=$r[nip]><img src='images/folder-users-icon.png' border='0' title='detail' /></a>
		        </tr>";
