...
function validasi(form){
  if (form.jdl_album.value == ""){
    alert("Anda belum mengisikan judul album...!!");
    form.jdl_album.focus();
    return (false);
  }
  return (true);
...
switch($_GET[act]){
  ...
  default:
    ...
    while ($r=mysql_fetch_array($tampil)){
       echo "<tr><td class='left' width='25'>$no</td>             
             <td class='left' width='120'><img src='../foto/img_album/kecil_$r[gbr_album]'></td>
  ...
  case "tambahalbum":
    echo "<h2>Tambah Album</h2>
          <form method=POST action='$aksi?module=album&act=input' enctype='multipart/form-data' onSubmit='return validasi(this)'>
  ...
  case "editalbum":
    ...
    echo "<h2>Edit Album</h2>
          <form method=POST enctype='multipart/form-data' action=$aksi?module=album&act=update enctype='multipart/form-data' onSubmit='return validasi(this)'>
          ...
          <tr><td class='left'>Gambar</td><td>    : <img src='../foto/img_album/kecil_$r[gbr_album]'></td></tr>
