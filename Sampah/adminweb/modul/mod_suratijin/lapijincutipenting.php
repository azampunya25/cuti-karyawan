...
$pdf->setFont('times','B',12,'C');
$pdf->setXY(20,48); $pdf->MultiCell(A4,5,'SURAT IZIN CUTI ALASAN PENTING',0,'C');
...
$pdf->setFont('times','',12,'C');
$pdf->text(20,70,'1. Diberikan cuti alasan penting untuk tahun ');$pdf->text(96,70,$datex);$pdf->text(106,70,'kepada Pegawai Negeri Sipil :');
...
$pdf->text(60,121,',karena mendampingi suami menjalani');
$pdf->text(130,121,$data['alasan']);
$pdf->text(35,127,',dengan ketentuan sebagai berikut :');
$pdf->text(35,133,'1. Sebelum menjalankan cuti tahunan wajib menyerahkan pekerjaannya kepada atasan');
$pdf->text(39,139,'langsung.');
$pdf->text(35,145,'2. Setelah selesai menjalankan cuti tahunan wajib melaporkan diri kepada atasan');
$pdf->text(39,150,'langsung dan bekerja kembali sebagaimana biasa.');
