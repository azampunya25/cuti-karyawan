...
$pdf->setFont('times','B',12,'C');
$pdf->setXY(20,48); $pdf->MultiCell(A4,5,'SURAT IZIN CUTI HAMIL',0,'C');
...
$pdf->setFont('times','',12,'C');
$pdf->text(20,70,'1. Diberikan cuti hamil untuk tahun');$pdf->text(85,70,$datex);$pdf->text(95,70,'kepada Pegawai Negeri Sipil :');
...
$pdf->text(55,115,'hari kalender,');
$pdf->text(80,115,'terhitung mulai tanggal');
$pdf->text(120,115,$data['tgl_mulai']);
$pdf->text(147,115,'sampai dengan');
$pdf->text(35,121,$data['tgl_akhir']);
$pdf->text(60,121,'dengan ketentuan sebagai berikut :');
$pdf->text(35,127,'1. Sebelum menjalankan cuti hamil wajib menyerahkan pekerjaannya kepada atasan');
$pdf->text(39,133,'langsung.');
$pdf->text(35,139,'2. Setelah selesai menjalankan cuti hamil wajib melaporkan diri kepada atasan');
