  ...
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
      ...
      , type: {
            email:      "Format Email yang Anda masukan tidak Valid."
          , url:        "url yang Anda masukan tidak valid."
          , urlstrict:  "url yang Anda masukan tidak valid."
          , number:     "Nomor yang anda masukan tidak valid."
          , digits:     "Masukan harus bilangan bulat."
          , dateIso:    "Tanggal yang Anda masukan tidak valid (YYYY-MM-DD)."
          , alphanum:   "Masukan harus berupa huruf atau angka."
          , phone:      "Nomor telepon yang Anda masukan tidak valid."
        }
      , notnull:        "Field tidak boleh kosong."
      , notblank:       "This value should not be blank."
      , required:       "Field tidak boleh kosong."
      , regexp:         "This value seems to be invalid."
      , min:            "Masukan harus lebih besar atau sama dengan %s."
      , max:            "Masukan harus lebih kecil atau sama dengan %s."
      , range:          "Masukan harus antara %s sampai %s."
      , minlength:      "Masukan harus %s karakter atau lebih."
      , maxlength:      "Masukan terlalu panjang. Harus harus kurang dari atau sama dengan %s karakter."
      , rangelength:    "Panjang masukan harus antara %s sampai %s karakter."
